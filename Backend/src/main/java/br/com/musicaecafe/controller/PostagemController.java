...
import br.com.musicaecafe.model.Postagem;
import br.com.musicaecafe.repository.PostagemRepository;
...
public class PostagemController {
	...
	@PostMapping
	public ResponseEntity<Postagem> postPostagemModel(@Valid @RequestBody Postagem postagem) {
		return ResponseEntity.status(HttpStatus.CREATED).body(postagemRepository.save(postagem));
	}

	@PutMapping
	public ResponseEntity<Postagem> putPostagemModel(@Valid @RequestBody Postagem postagem) {
