...
import br.com.musicaecafe.model.Tema;
import br.com.musicaecafe.repository.TemaRepository;
...
public class TemaController {
	...
	@PostMapping
	public ResponseEntity<Tema> postPLTemaModel(@Valid @RequestBody Tema tema) {
		return ResponseEntity.status(HttpStatus.CREATED).body(temaRepository.save(tema));
	}

	@PutMapping 
	public ResponseEntity<Tema> putPostagemModel(@Valid @RequestBody Tema tema) {
